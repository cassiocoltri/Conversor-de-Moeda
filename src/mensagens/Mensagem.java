...
public class Mensagem {
    ...
    public void apresentacao() {
        ...
        System.out.println("[1] Para Consulta uma Cotação.");
        ...
        System.out.println("[5] Peso argentino (ARS) =>> Dolar (USD)");
        System.out.println("[6] Dólar (USD) =>> Real brasileiro (BRL)");
        System.out.println("[7] Real brasileiro (BRL) =>> Dólar (USD)");
        System.out.println("[8] Dólar (USD) =>> Peso colombiano (COP)");
        System.out.println("[9] Peso colombiano (COP) =>> Dólar (USD)");
